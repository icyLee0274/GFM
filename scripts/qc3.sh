...
#echo "**************** Training Gauge ****************"
#python run_example.py $EXAMPLE --verbose --data "data/$DATA.npz" --norm $NORM --train --batch_size $BATCH --hidden $HIDDEN --method gauge_vanilla.yaml

#echo "**************** Testing Gauge Vanilla ****************"
#python run_example.py $EXAMPLE --verbose --data "data/$DATA.npz" --norm $NORM --test --n_gen $GEN --repeat $REPEAT --method gauge_vanilla.yaml
...
#python run_example.py $EXAMPLE --verbose --data "data/$DATA.npz" --norm $NORM --test --n_gen $GEN --repeat $REPEAT --method gauge_project.yaml
#
#
